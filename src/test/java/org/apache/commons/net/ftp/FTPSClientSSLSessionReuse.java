...
public class FTPSClientSSLSessionReuse extends FTPSClient {
    ...
    protected boolean needHostForSni;

    public void setNeedHostForSni(final boolean needHostForSni) {
        this.needHostForSni = needHostForSni;
    }

    public FTPSClientSSLSessionReuse(final boolean isImplicit) throws Exception {
        ...
        setPassiveNatWorkaroundStrategy(hostname -> _hostname_);
